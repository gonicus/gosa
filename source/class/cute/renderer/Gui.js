...
construct : function()
      {
        ...
        this._flexMap = {
          "QSizePolicy::Fixed": 0,
          "QSizePolicy::Ignored": 0,
          "QSizePolicy::Minimum": 0,
          "QSizePolicy::Maximum": 10,
          "QSizePolicy::Preferred": 1,
          "QSizePolicy::Expanding": 4,
          "QSizePolicy::MinimumExpanding": 2
        };
  ...
  members :
{
  ...
  processSpacer : function(node)
  {
    ...
    properties['_widgetType_'] = "spacer"
