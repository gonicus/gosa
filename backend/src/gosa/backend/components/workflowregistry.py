...
class WorkflowRegistry(Plugin):
    ...
    def __init__(self):
        ...
        self.__path = Environment.getInstance().config.get("core.workflow_path", "/var/lib/gosa/workflows")
    ...
    def addWorkflow(self, user, xml_file_path):
        #TODO: ACL check, check if exists, etc.
        return self.__add(xml_file_path)

    def __add(self, xml_file_path):
        """
        ...
        root = objectify.parse(xml_file_path, parser).getroot()
    ...
    def _update_map(self):
        ...
        for file in os.listdir(self.__path):
            self.__add(os.path.join(self.__path, file))
