...
/**
 * Simplified controller for actions that can be done on a user object without being logged in (e.g. change password
 * after the recovery process has been succeeded)
 */
qx.Class.define("gosa.data.controller.RecoveryAction", {
